...
function userSummaryData(positionWeeksData, username) {
  ...
  if (annualBestPerformanceWeek.overPerformed !== 0) {
    user.annualBestPerformance.week = annualBestPerformanceWeek.weekNumber;
    user.annualBestPerformance.table = annualBestPerformanceWeek.table;
    user.annualBestPerformance.position =
      annualBestPerformanceWeek.scores.findIndex(
        (s) => s.username === username
      ) + 1;
    user.annualBestPerformance.players = annualBestPerformanceWeek.scores.length;
  }
  ...
  if (annualWorstPerformanceWeek.underPerformed !== 0) {
    user.annualWorstPerformance.week = annualWorstPerformanceWeek.weekNumber;
    user.annualWorstPerformance.table = annualWorstPerformanceWeek.table;
    user.annualWorstPerformance.position =
