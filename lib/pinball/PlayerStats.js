...
export default function PlayerSummaryData(data, username) {
  ...
  if (user) {
    ...
    const sortedByWinPercentage = seasonWeeksData[0].scores
      .sort((a, b) => b.seasonWinPercentage - a.seasonWinPercentage);
    ...
    const endIndex = Math.min(
      sortedByWinPercentage.length - 1,
      startIndex + 5
    );
    ...
    const sortedByPoints = seasonWeeksData[0].scores
      .sort((a, b) => b.cumulativePoints - a.cumulativePoints);
