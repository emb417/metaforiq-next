  ...
  return (
    <div className={styles.avatar}>
      ...
      <div className={styles.caption}>
        ...
        <p className={styles.name}>MetaforIQ Founder</p>
        <div className={styles.socialLinks}>
          ...
          <a
            href="https://www.goodreads.com/emb417"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className={styles.icon + " " + styles.goodreads}
            >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Email Eric Brousseau"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
