...
import BioImage from "@/components/App/Avatar/Avatar";
      ...
      <div className="container">
        <div className={styles.content}>
          ...
          <h3 className={styles.title}>
            25 years of building at the intersection of product and engineering.
          </h3>
          <p>
          ...
          <p>
            Along the way, I’ve held leadership roles at Nike, Vevo, New Relic,
            and Dell. I’ve seen what happens when teams move too fast without a
            strategy, and I’ve seen the magic that happens when engineering and
            product are perfectly aligned.
          </p>
          <p>
            ...
            craze or the current AI gold rush—and lose sight of the actual user
            problem. They build complex solutions for simple needs, or they
            scale before they’ve validated their core assumptions.
          </p>
          <p>
